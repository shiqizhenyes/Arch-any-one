...
echo "${c1}            \`/++++/+++++++:           %s"
echo "${c1}           \`/++++++++++++++:          %s"
echo "${c1}          \`/+++o${c2}oooooooo${c1}oooo/\`        %s"
echo "${c2}         ${c1}./${c2}ooosssso++osssssso${c1}+\`       %s"
echo "${c2}        .oossssso-\`\`\`\`/ossssss+\`      %s"
echo "${c2}       -osssssso.      :ssssssso.     %s"
echo "${c2}      :osssssss/        osssso+++.    %s"
echo "${c2}     /ossssssss/        +ssssooo/-    %s"
echo "${c2}   \`/ossssso+/:-        -:/+osssso+-  %s"
echo "${c2}  \`+sso+:-\`                 \`.-/+oso: %s"
echo "${c2} \`++:.                           \`-/+/%s"
echo "${c2} .\`                                 \`/%s"
